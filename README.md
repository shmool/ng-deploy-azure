...
[blog post announcing Static websites on Azure Storage](https://azure.microsoft.com/blog/static-websites-on-azure-storage-now-generally-available/?WT.mc_id=javascript-0000-shjacobs).
...
- Azure subscription. If you don't have one, [create your Azure free account](https://azure.microsoft.com/free/?WT.mc_id=javascript-0000-shjacobs).
...
Read Microsoft's [privacy statement](https://privacy.microsoft.com/privacystatement/?WT.mc_id=javascript-0000-shjacobs) to learn more. 
...
[MSRC PGP](https://technet.microsoft.com/security/dn606155/?WT.mc_id=javascript-0000-shjacobs) key, can be found in
the [Security TechCenter](https://technet.microsoft.com/security/default/?WT.mc_id=javascript-0000-shjacobs).
